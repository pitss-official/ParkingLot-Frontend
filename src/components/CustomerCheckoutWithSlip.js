...
export default class CustomerCheckoutWithSlip extends React.Component{
    ...
    post(){
        axios.post(this.url+'/vehicle/empcheckOut',{spotID:this.state.id}).then(res=>{
            swal.fire("You have been billed with Amount: "+res.data.amount,"You have been billed for hours: "+res.data.hours);
        }).catch(err=>{
